...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-09-2025 a las 15:21:59
...
(1, '2025-02-21', 0, 1, 1, 1),
(2, '2025-12-21', 0, 2, 2, 2),
(3, '2025-06-10', 0, 3, 1, 3),
(4, '2025-09-30', 10, 1, 1, 1),
(5, '2025-09-02', 50, 3, 2, 1);
...
INSERT INTO `t_usuario` (`id_usuario`, `nombre`, `apellido`, `email`, `password`, `id_rol`) VALUES
